...
class Notification(models.Model):
    ...
    _LIKED_TEMPLATE = u'<a href="/{0}/">{1}</a> 赞了你的动态: <a href="/feeds/{2}/">{3}</a>'
    _COMMENTED_TEMPLATE = u'<a href="/{0}/">{1}</a> 评论了你的动态: <a href="/feeds/{2}/">{3}</a>'
    _FAVORITED_TEMPLATE = u'<a href="/{0}/">{1}</a> 收藏了你的动态: <a href="/questions/{2}/">{3}</a>'
    _ANSWERED_TEMPLATE = u'<a href="/{0}/">{1}</a> 回答了你的问题: <a href="/questions/{2}/">{3}</a>'
    _ACCEPTED_ANSWER_TEMPLATE = u'<a href="/{0}/">{1}</a> 接受了你的问题: <a href="/questions/{2}/">{3}</a>'
    _EDITED_ARTICLE_TEMPLATE = u'<a href="/{0}/">{1}</a> 更改了你的贴子: <a href="/article/{2}/">{3}</a>'
    _ALSO_COMMENTED_TEMPLATE = u'<a href="/{0}/">{1}</a> 也评论了你的动态: <a href="/feeds/{2}/">{3}</a>'
