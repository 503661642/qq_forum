...
class Profile(models.Model):
    ...
    def get_picture(self):
        no_picture = 'http://ico.ooopic.com/iconset01/coquette-icons-set/gif/78858.gif'
        try:
            ...
            if os.path.isfile(filename):
                ...
                gravatar_url = u'http://ico.ooopic.com/iconset01/coquette-icons-set/gif/78858.gif'
                return gravatar_url
        except Exception, e:
            return no_picture
