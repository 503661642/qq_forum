...
from qq_forum.core.forms import ProfileForm, ChangePasswordForm
from qq_forum.feeds.models import Feed
from qq_forum.feeds.views import FEEDS_NUM_PAGES
from qq_forum.feeds.views import feeds
...
def settings(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            user.save()
            messages.add_message(request, messages.SUCCESS, '个人信息更改成功.')
    else:
